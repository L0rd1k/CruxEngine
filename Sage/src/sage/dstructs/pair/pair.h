...
inline constexpr bool operator==(const sage::pair<T1, T2>& val1, const sage::pair<T1, T2>& val2) {
...
template <typename T1, typename T2>
inline void swap(sage::pair<T1, T2>& val1, sage::pair<T1, T2>& val2) noexcept {
    val1.swap(val2);
}

template <typename T1, typename T2>
inline sage::pair<T1, T2> make_pair(T1&& val1, T2&& val2) {
