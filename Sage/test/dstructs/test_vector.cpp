...
#include "src/sage/dstructs/vector/vector.h"
...
TEST(Vector, InitializerListConstructor) {
    sage::vector<int> vec_t{1, 3, 5, 7, 9};
...
TEST(Vector, CopyConstruct) {
    sage::vector<int> vec1 = {1, 2, 3, 4, 5};
    sage::vector<int> vec2(vec1);
...
TEST(Vector, MoveConstruct) {
    sage::vector<int> vec1 = {1, 2, 3, 4, 5};
    sage::vector<int> vec2(std::move(vec1));
    EXPECT_EQ(vec2.capacity(), 5);
    EXPECT_EQ(vec2.size(), 5);
    EXPECT_EQ(vec2[3], 4);
}
...
TEST(Vector, DataAtPosOperator) {
    sage::vector<int> vec = {12, 23, 42, 12, 32};
...
TEST(Vector, GetData) {
    sage::vector<int> vec{16, 92, 71};
    EXPECT_EQ(*(vec.data() + 1), 92);
}

TEST(Vector, IteratorOperation) {
    sage::vector<int> vec{84, 38, 12};
...
TEST(Vector, ConstIteratorOperation) {
    const sage::vector<int> vec{84, 38, 12};
...
TEST(Vector, SwapData) {
    sage::vector<int> v1 = {1,2,3};
    sage::vector<int> v2 = {3,4,1};
    sage::swap(v1, v2);
