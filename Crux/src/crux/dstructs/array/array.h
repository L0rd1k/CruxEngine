...
public:
    ...
    using citerator = crux::LegacyRandomAccessIterator<const Type>;
    using riterator = crux::reverse_iterator<iterator>;
    using creverse_iterator = crux::reverse_iterator<citerator>;
